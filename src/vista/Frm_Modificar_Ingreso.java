                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cbTipoTransaccion, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        SwingWorker<List<TipoTransaccion>, Void> worker = new SwingWorker<List<TipoTransaccion>, Void>() {
            ...
            protected List<TipoTransaccion> doInBackground() {
                try {
                    ...
                    List<String> categorias = java.util.Arrays.asList("INGRESO", "REPOSICION");
    ...
    private void guardarCambios() {
        try {
            ...
            if (importeStr.isEmpty()) {
                JOptionPane.showMessageDialog(this, "El importe es obligatorio.", "Validación", JOptionPane.WARNING_MESSAGE);
            ...
            if (importe.compareTo(BigDecimal.ZERO) <= 0) {
                JOptionPane.showMessageDialog(this, "El importe debe ser mayor que 0.", "Validación", JOptionPane.WARNING_MESSAGE);
                txtImporte.requestFocus();
                return;
            }
