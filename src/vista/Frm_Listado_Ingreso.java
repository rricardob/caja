...
public class Frm_Listado_Ingreso extends javax.swing.JInternalFrame {
        ...
        private void btn_reporteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_reporteActionPerformed
                try {
                        ...
                        // Formatear fechas para el reporte si es necesario
                        ...
                        // Buscamos el reporte en la carpeta de recursos del classpath
                        InputStream reportStream = getClass().getResourceAsStream("/recursos/rpt_ingresos.jasper");

                        if (reportStream == null) {
                                JOptionPane.showMessageDialog(this,
                                                "No se encontró el archivo del reporte (rpt_ingresos.jasper) en los recursos.",
                        ...
                        viewer.setTitle("Visualizador de Reportes - Ingresos");
                        viewer.setVisible(true);

                } catch (Exception ex) {
                        LOGGER.log(Level.SEVERE, "Error al generar el reporte de ingresos", ex);
