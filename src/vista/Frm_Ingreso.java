...
public class Frm_Ingreso extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        panel_registro_ingresos
                .setBorder(javax.swing.BorderFactory.createTitledBorder("Formulario De Registro - Ingresos"));
        ...
        panel_registro_ingresosLayout.setHorizontalGroup(
                panel_registro_ingresosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panel_registro_ingresosLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(panel_registro_ingresosLayout
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                panel_registro_ingresosLayout.createSequentialGroup()
                                                        .addGroup(panel_registro_ingresosLayout
                                                                .createParallelGroup(
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(panel_registro_ingresos, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addComponent(panel_registro_ingresos, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(15, 15, 15)
        ...
        try {
            ...
            if (c == null) {
                int resp = JOptionPane.showConfirmDialog(this,
                        "Cliente no encontrado. ¿Desea crear uno nuevo manualmente?", "Cliente no encontrado",
                ...
                if (resp == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        javax.swing.JDesktopPane desktop = (javax.swing.JDesktopPane) javax.swing.SwingUtilities
                                .getAncestorOfClass(
                        ...
                        if (desktop != null) {
                            ...
                            JOptionPane.showMessageDialog(this, msg, "Error de configuración",
                                    JOptionPane.ERROR_MESSAGE);
                        }
        ...
        try {
            ...
            if (idTrans > 0) {
                ...
                LOGGER.log(Level.INFO, "Ingreso registrado ID: {0}, tipoId: {1}, clienteId: {2}, importe: {3}",
                        new Object[] { idTrans, tipoSeleccionado.getId_tipo(), clienteSeleccionado.getId_cliente(),
                                importe });
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un ingreso para eliminar.", "Advertencia",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (t == null) {
            JOptionPane.showMessageDialog(this, "Error al obtener el ingreso seleccionado.", "Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
            ...
            SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
                ...
                protected void done() {
                    try {
                        ...
                        if (eliminado) {
                            JOptionPane.showMessageDialog(Frm_Ingreso.this, "Ingreso eliminado correctamente.", "Éxito",
                                    JOptionPane.INFORMATION_MESSAGE);
                            cargarIngresosEnTabla();
                        } else {
                            JOptionPane.showMessageDialog(Frm_Ingreso.this, "No se pudo eliminar el ingreso.", "Error",
                                    JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        LOGGER.log(Level.SEVERE, "Error al eliminar ingreso", ex);
                        JOptionPane.showMessageDialog(Frm_Ingreso.this, "Error al eliminar: " + ex.getMessage(),
                                "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            };
